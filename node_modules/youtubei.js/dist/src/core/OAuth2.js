...
class OAuth2 {
    ...
    cacheCredentials() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield ((_a = __classPrivateFieldGet(this, _OAuth2_session, "f").cache) === null || _a === void 0 ? void 0 : _a.set('youtubei_oauth_credentials', data.buffer));
        });
    }
    removeCache() {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            yield ((_a = __classPrivateFieldGet(this, _OAuth2_session, "f").cache) === null || _a === void 0 ? void 0 : _a.remove('youtubei_oauth_credentials'));
        });
    }
    ...
    getClientID() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((script_url_body = Constants.OAUTH.REGEX.TV_SCRIPT.exec(yttv_response_data)) !== null) {
                ...
                const script_response = yield __classPrivateFieldGet(this, _OAuth2_instances, "a", _OAuth2_http_get).fetch(script_url_body[1], { baseURL: Constants.URLS.YT_BASE });
    ...
    validateTokens(tokens) {
        const propertiesAreValid = (Boolean(tokens.access_token) &&
            Boolean(tokens.expiry_date) &&
            Boolean(tokens.refresh_token));
        const typesAreValid = (typeof tokens.access_token === 'string' &&
            typeof tokens.expiry_date === 'string' &&
            typeof tokens.refresh_token === 'string');
        return typesAreValid && propertiesAreValid;
    }
}
_OAuth2_session = new WeakMap(), _OAuth2_instances = new WeakSet(), _OAuth2_loadFromCache = function _OAuth2_loadFromCache() {
    return __awaiter(this, void 0, void 0, function* () {
        var _a;
        const data = yield ((_a = __classPrivateFieldGet(this, _OAuth2_session, "f").cache) === null || _a === void 0 ? void 0 : _a.get('youtubei_oauth_credentials'));
        if (!data)
            return false;
