...
export default class Search extends Feed {
    constructor(actions, data, already_parsed = false) {
        ...
        this.results = (_d = (_c = contents.find((content) => content.is(ItemSection) && (content.contents && content.contents.length > 0))) === null || _c === void 0 ? void 0 : _c.as(ItemSection)) === null || _d === void 0 ? void 0 : _d.contents;
        ...
        this.refinement_cards = (_e = this.results) === null || _e === void 0 ? void 0 : _e.firstOfType(HorizontalCardList);
    }
    /**
