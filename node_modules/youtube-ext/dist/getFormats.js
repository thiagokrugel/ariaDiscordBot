 ...
 */
const getFormats = (stream_1, ...args_1) => __awaiter(void 0, [stream_1, ...args_1], void 0, function* (stream, options = {}) {
...
const getCipherFunction = (url_1, ...args_2) => __awaiter(void 0, [url_1, ...args_2], void 0, function* (url, options = {}) {
    ...
    if (typeof options.evaluator === "function") {
        ...
        if ((0, utils_1.isModuleInstalled)("@ohmyvm/vm")) {
            evaluator = evalInOhMyVM;
        }
        else if ((0, utils_1.isModuleInstalled)("isolated-vm")) {
            evaluator = evalInIsolatedVM;
        }
...
const evalInOhMyVM = (code) => __awaiter(void 0, void 0, void 0, function* () {
    const vm = (0, utils_1.requireOrThrow)("@ohmyvm/vm");
    const context = new vm.OhMyVm();
    return {
        decoder: (str) => {
            const src = `var __cafeBabe__ = ${code}${code.endsWith(";") ? "" : ";"}__cafeBabe__("${str}");`;
...
const evalInIsolatedVM = (code_1, ...args_3) => __awaiter(void 0, [code_1, ...args_3], void 0, function* (code, options = {}) {
    var _j;
