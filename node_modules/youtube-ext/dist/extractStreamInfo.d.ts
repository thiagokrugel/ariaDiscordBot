 ...
 */
export declare const extractStreamInfo: (url: string, options?: ExtractStreamInfoOptions) => Promise<VideoStream>;
export declare const prepareStreamInfo: (data: string, stream: VideoStream) => void;
